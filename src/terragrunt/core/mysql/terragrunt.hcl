terraform {
  source = "../../..//modules/components/mysql"
}
...
dependency "base" {
  ...
  mock_outputs = {
    ...
    subnets = {
      mysql = {
        id = "/subscriptions/df980cf1-51b3-458b-861a-ae9be3ff0e8a/resourceGroups/mock-dev-rg/providers/Microsoft.Network/virtualNetworks/mock-dev-vnet/subnets/mock-mysql-subnet"
      }
...
inputs = {
  ...
  delegated_subnet_id = dependency.base.outputs.subnets["mysql"].id
  private_dns_zone_id = dependency.base.outputs.private_dns_zones["mysql"].id
}